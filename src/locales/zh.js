export default {
  ...
  restore_ledger: {
    title: '从Ledger恢复',
    usage: '请确保您的固件和软件都是最新的版本。连接您的LedgerWallet，进入Sbercoin APP，然后点击下面的连接按钮尝试连接。',
    download: '没有Sbercoin APP? 请按照这个安装 https://www.ledgerwallet.com/apps/manager',
    connect: '连接',
  },
  view: {
    title: '查看钱包信息',
